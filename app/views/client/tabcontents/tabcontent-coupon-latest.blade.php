			        ...
			        <div id="coupon-generator">
			        	<div class="coupon-generator-handler">
			        		<div class="coupon-image-handler" id="coupon-image-handler">
			        			<p class="draggable" title="Click to customize this text." id="{{Str::random(40)}}" style="font-size:90px; color:white; margin-top: -10px">
			        				FREE<span class="coupon_removetxt" title="remove text">x</span>
			        			</p>
			        			<p class="draggable" title="Click to customize this text." id="{{Str::random(40)}}" style="color:white;">
			        				{{ decode($business->name) }}<span class="coupon_removetxt" title="remove text">x</span></p>
			        			</p>
			        		</div>
			        	</div>
			        	<div class="add-text">
			        		<div class="form-group">
				        		...
				        		<button id="btn_addtext">Add</button>
				        		<span>&#8226;</span>
			        		...
			        		<div class="form-group">
				        		...
				        		<button id="coupon_updatebackground">Update Background Color</button>
